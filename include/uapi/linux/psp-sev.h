...
typedef enum {
	...
	SEV_RET_TIO_SPDM_REQ_LENGTH		= 0x28,
	SEV_RET_TIO_SPDM_SCRATCH_LENGTH		= 0x29,
	SEV_RET_TIO_SPDM_OUT_LENGTH		= 0x2A,
	SEV_RET_TIO_INCORRECT_BUFFER_LENGTH	= 0x2B,
	SEV_RET_TIO_INVALID_CONTEXT		= 0x2C,
	...
	SEV_RET_ERR_TMR_RELEASE                   = 0x8009,
	SEV_RET_ERR_TMR_SETUP                     = 0x800A,
	...
	SEV_RET_ERR_HAL_SEV_TOPOLOGY_INFO         = 0x900F,
